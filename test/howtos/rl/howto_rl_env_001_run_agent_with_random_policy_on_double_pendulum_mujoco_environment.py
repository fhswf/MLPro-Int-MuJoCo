...
## -- Package : mlpro_int_mujoco
## -- Module  : howto_rl_env_001_run_agent_with_random_policy_on_double_pendulum_mujoco_environment.py
## -------------------------------------------------------------------------------------------------
## -- History :
...
## -- 2024-05-08  1.2.2     SY        Migration from MLPro to MLPro-Int-MuJoCo
## -------------------------------------------------------------------------------------------------

"""
Ver. 1.2.2 (2024-05-08)
...
class MyScenario (RLScenario):
    ...
    def _setup(self, p_mode, p_ada: bool, p_visualize:bool, p_logging) -> Model:
        ...
        model_file = os.path.join(os.path.dirname(mlpro_int_mujoco.__file__), "systems", "doublependulum.xml")
